...
public class Constain {
   ...
   public static final String feauterFragment = "feauterFragment";
   public static final String[] arrayRecommand={"Phát triển","Đại số", "Sác xuất", "Dữ liệu", "Tiếng anh", "Lập trình"};
}
