...
this.name = name;
    ...
    private class Example {
        ...
        @Expose
        private GetAllCourseReponse getAllCourseReponse;
        ...
        public GetAllCourseReponse getGetAllCourseReponse() {
            return getAllCourseReponse;
        }

        public void setGetAllCourseReponse(GetAllCourseReponse getAllCourseReponse) {
            this.getAllCourseReponse = getAllCourseReponse;
        }
